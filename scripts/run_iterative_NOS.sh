...
do  
    ...
    HYDRA_FULL_ERROR=1 CUDA_VISIBLE_DEVICES=1 python iterativeBO.py pretrained_ckpt=mdlm/$protein data=$protein problem=protein_NOS_discrete model=mdlm algorithm=NOS_discrete
done